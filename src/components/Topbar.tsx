...
const NAV: NavItem[] = [
  ...
  {
    // La agencia no ve ningún tarifario: ni lo que cuesta el proveedor…
  ...
  {
    // …ni el tarifario de clientes. El proveedor tampoco: nunca ve lo que se le
    // factura al cliente. Queda solo para el admin.
